...
| Border Radius | `8px` |
| Font | `12px / Medium` |
| Dropdown 방향 | 기본 아래로 열림 · 바텀시트 내부는 위로 드롭업 |
| Dropdown 닫힘 | 바깥 클릭 시 닫힘 |
| Selected outline | `2px solid #111111` |
...
### 4.5 BottomSheet (아카이브 수정/삭제)

아카이브 카드 클릭 시 올라오는 수정/삭제 시트.
...
| Padding X | `16px` |
| Padding Bottom | `32px` |
| Handle | `40px × 4px · #E5E5EA` |
| 딤 배경 | `rgba(0,0,0,0.4)` · 클릭시 닫힘 |
| 카테고리 선택 | 위로 드롭업 (Drop-up) |

**버튼 상태**

| 버튼 | Background | Text | 조건 |
|:---|:---|:---|:---|
| 저장하기 | `#111111` | `#F9F9F9` | 이름 있을 때 Enabled |
| 저장하기 (Disabled) | `#8E8E93` | `#FFFFFF` | 이름 비어있을 때 |
| 삭제하기 | `#FFF5F5` | `#FF3B30` | 항상 활성 |
...
| 버전 | 날짜 | 변경 내용 |
|:---|:---|:---|
| 1.2.0 | 2026-06-09 | Badge 드롭다운 인터랙션 규칙 추가, BottomSheet 컴포넌트 사양 추가 (수정/삭제), 바텀시트 내 카테고리 드롭업 규칙 정의 |
